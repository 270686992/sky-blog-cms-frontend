<template>
  <div class="container">
    ...
    <el-table stripe v-loading="loading" :data="tableData">
      ...
      <el-table-column prop="root_id" label="所属一级评论 ID" min-width="120">
        <template slot-scope="scope">{{ scope.row.root_id | idFormat }}</template>
      </el-table-column>

      <el-table-column prop="parent_id" label="父评论 ID" min-width="100">
      ...
      <el-table-column prop="ip" label="评论者 IP" min-width="150"></el-table-column>

      <el-table-column prop="address" label="IP 对应位置" :show-overflow-tooltip="true" min-width="150"></el-table-column>

      <el-table-column prop="content" label="评论/回复内容" :show-overflow-tooltip="true" min-width="200"></el-table-column>
